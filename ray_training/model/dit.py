...
class DiT(nn.Module):
    ...
    def __init__(self, heads: int = 24, embedding_size: int = 1536, patch_size: int = 2, depth: int = 14,
...
def test_dit():
    ...
    # latent channels must be 16
    latent = torch.randn(1, 16, 28, 28)
    encoder_hidden_states = torch.randn(1, 45, 4096)
