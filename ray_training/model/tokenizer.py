...
class TorchTokenizer: # Byte-Level Byte-Pair Tokenizer
    def __init__(self, tokenizer_path: str = "tokenizer.json", max_length: int = 77):
        ...
        file_path = os.path.join(current_dir, "src", "model", tokenizer_path)
...
class UnigramTokenizer: # For T5 Encoder
    def __init__(self, max_length: int = 77):
        ...
        current_dir = '/data0/teja_codes/ImmersoAiResearch/FlowModelTraining/miniDiffusion'
        tokenizer_json_path = os.path.join(current_dir, "encoders", "hub", "checkpoints", "t5_tokenizer", "spiece.model")
